...
<body class="bg-light">
    ...
    <div class="container py-4" id="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <button class="btn btn-outline-secondary me-2 month-btn"
                        data-year="{{ $prev->year }}"
                        data-month="{{ $prev->month }}">←</button>
                <button class="btn btn-outline-secondary month-btn"
                        data-year="{{ $next->year }}"
                        data-month="{{ $next->month }}">→</button>
            </div>
        </div>
            ...
            <div class="col-md-2">
                <div class="d-flex flex-column gap-2">
                    @foreach ($grades as $gradeItem)
                        ...
                        @endphp
                        <button class="btn {{ $gradeClass }} grade-btn {{ $grade === $g ? 'active' : '' }}"
                                data-grade="{{ $g }}"
