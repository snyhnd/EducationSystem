  ...
  <div class="wrap">
    ...
    <div class="card">
      ...
      <div class="info-row">
        ...
        <div class="value">{{ $name ?? session('admin_name', '（未設定）') }}</div>
      </div>

      <div class="info-row">
        <div class="label">メールアドレス</div>
        <div class="value">{{ $email ?? session('admin_email', '（未設定）') }}</div>
      </div>
    </div>
  </div>
</body>
